...
call actions#AddAction('grunt test', {'action': funcref#Function('actions#CompileRHSSimple', {'args': [['call vim_addon_errorformats#SetErrorFormat("grunt coffee")'], ["grunt", "--no-color", "test"]]})})
